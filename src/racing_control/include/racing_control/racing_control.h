...
private:
    ...
    // own -------------------------------------------------------------------------------
    rclcpp::Subscription<std_msgs::msg::Bool>::SharedPtr patrol_command_subscriber_;
    rclcpp::Subscription<std_msgs::msg::Bool>::SharedPtr parking_begin_subscriber_;
    rclcpp::Publisher<std_msgs::msg::Bool>::SharedPtr patrol_result_publisher_;
    rclcpp::Subscription<ai_msgs::msg::Point>::SharedPtr traffic_light_subscriber_;
    void patrol_command_callback(const std_msgs::msg::Bool::SharedPtr bool_msg);
    void parking_begin_callback(const std_msgs::msg::Bool::SharedPtr bool_msg);
    void traffic_light_callback(const ai_msgs::msg::Point::SharedPtr point_msg);
    // own -------------------------------------------------------------------------------
